...
namespace GameProject.Items
{
	...
	{
		public ArcherHelmet(GraphicsDevice gd, Player p, Texture2D slotTexture, SpriteFont f, Texture2D t, Vector2 scale) : base(gd, p, slotTexture, f, t, scale)
		{
		}
